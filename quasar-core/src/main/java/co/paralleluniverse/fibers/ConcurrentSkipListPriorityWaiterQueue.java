...
import co.paralleluniverse.concurrent.util.*;
import co.paralleluniverse.common.util.UtilUnsafe;
import java.util.*;

class ConcurrentSkipListPriorityWaiterQueue<E> extends AbstractQueue<E>
    ...
    private Node<E> node(E kkey, Node<E> next) {
        final Node<E> n;
//        if (kkey instanceof FiberTimedScheduler.ScheduledFutureTask) {
//            n = (Node<E>)((FiberTimedScheduler.ScheduledFutureTask)kkey).node;
//            assert n.key == kkey;
//            n.value = kkey;
//            n.next = next;
//        } else
            n = new Node<>(kkey, next);
        return n;
    }
    /**
     ...
     */
    public ConcurrentSkipListPriorityWaiterQueue() {
     ...
     */
    public ConcurrentSkipListPriorityWaiterQueue(Comparator<? super E> comparator) {
        this.comparator = comparator;
        initialize();
    }

    public ConcurrentSkipListPriorityWaiterQueue(Collection<? extends E> m) {
        this.comparator = null;
        initialize();
        addAll(m);
    }
     ...
     */
    @Override
    public ConcurrentSkipListPriorityWaiterQueue<E> clone() {
        ConcurrentSkipListPriorityWaiterQueue<E> clone = null;
        try {
            clone = (ConcurrentSkipListPriorityWaiterQueue<E>) super.clone();
     ...
     * method.
     */
    private void buildFromSorted(ConcurrentSkipListPriorityWaiterQueue<E> pq) {
        if (pq == null)
            throw new NullPointerException();
    ...
    class Iter implements Iterator<E> {
        ...
        public void remove() {
            ...
            ConcurrentSkipListPriorityWaiterQueue.this.remove(l.key);
            lastReturned = null;
        }
    }
    ...
    static {
        try {
            UNSAFE = UtilUnsafe.getUnsafe();
            Class k = ConcurrentSkipListPriorityWaiterQueue.class;
